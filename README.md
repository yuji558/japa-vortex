local vortexlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/REDzHUB/RedzLibV5/main/Source.Lua"))()
local Window = vortexlib:MakeWindow({
  Title = "vortex : Blox Fruits",
  SubTitle = "by japa",
...
Discord:AddDiscordInvite({
  ...
  Logo ="content://media/external/downloads/1000019104"
  Invite = "https://discord.gg/ysWgxruT"
})
